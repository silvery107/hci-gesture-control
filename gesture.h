...
int gesture()
{
	...
	Mat tmpPic[5];
	tmpPic[0] = imread("./template_pictures/hand1.png", cv::IMREAD_GRAYSCALE);
	tmpPic[1] = imread("./template_pictures/hand2.png", cv::IMREAD_GRAYSCALE);
	tmpPic[2] = imread("./template_pictures/hand3.png", cv::IMREAD_GRAYSCALE);
	tmpPic[3] = imread("./template_pictures/hand4.png", cv::IMREAD_GRAYSCALE);
	tmpPic[4] = imread("./template_pictures/hand5.png", cv::IMREAD_GRAYSCALE);
