...
int main(void)
{
    ...
    while (true)
    {
        ...
        cvui::checkbox(frame, 30, 200, "Flappybird", &choice5);

        if (cvui::button(frame, 30, 160, "face recognition"))
        {
            traject_face();
        }
        if (choice6)
        ...
        cvui::checkbox(frame, 30, 290, "Flappybird", &choice6);
        if (choice7)
        {
            capMode = 2;
        }
        cvui::checkbox(frame, 30, 310, "trajectory", &choice7);
        if (cvui::button(frame, 30, 250, "cap recognition"))
        {
            traject_cap();
        }
